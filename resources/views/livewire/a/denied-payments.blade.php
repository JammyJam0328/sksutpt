<x-admin-page-layout>
    <x-slot name="title">
        <x-card class="flex items-center justify-between shadow">
            <div class="flex space-x-3 text-green-600">
                ...
                <h1 class="text-2xl font-semibold ">Manage Payments | Denied Payments</h1>
            </div>
            <div x-data="{ filter: '3' }"
    ...
    <x-card class="shadow">
        @include('crud.a.manage-denied-payment.denied-table')
        {{-- @include('crud.a.manage-approved-payments.option-modal')
        @include('crud.a.manage-approved-payments.view-application') --}}
    </x-card>
</x-admin-page-layout>
