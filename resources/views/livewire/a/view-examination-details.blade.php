<x-admin-page-layout>
    <x-slot name="title">
        <x-card class="flex items-center justify-between shadow">
            <div class="flex space-x-3 text-green-600">
                ...
                <h1 class="text-2xl font-semibold ">Examination Details</h1>
            </div>
            <div id="page-actions"
    ...
    <x-card class="shadow">
        @include('crud.a.view-examination-details.details')
        @include('crud.a.view-examination-details.add-test-center')
