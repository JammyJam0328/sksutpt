        ...
        <div class="space-y-8 divide-y divide-gray-200">
            ...
            <div>
                <div class="grid grid-cols-1 mt-6 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="space-y-2 sm:col-span-6">
                        <x-input label="Scanned copy of SHS first semester report card (PDF format)"
                            type="file"
                        ...
                        @if ($copy_of_gpa != '')
                            <span class="text-green-600">File uploaded (file id : {{ $copy_of_gpa }})</span>
                        @endif
                    </div>
                    <div class="space-y-2 sm:col-span-6">
                        <x-input label="Principal/Head Certification or School ID (PDF format)"
                            type="file"
                            accept="application/pdf"
                            placeholder="Upload"
                        ...
                        @if ($principal_certification_or_school_id != '')
                            <span class="text-green-600">File uploaded (file id :
                                {{ $principal_certification_or_school_id }})</span>
                        @endif
                    </div>
